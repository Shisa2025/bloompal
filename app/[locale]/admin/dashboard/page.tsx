...
import { BarChart, LineChart } from "@/app/admin/dashboard/_components/charts";
  ...
  return (
    <>
      ...
      <section className={styles.statsGrid} aria-label={t("dashboardMetrics")}>
        ...
        <StatCard label={t("rewardsEarned")} value={number.format(rewardCount)} detail={t("rewardDetail", { flowers: overview.flowerCount, bugs: overview.bugCount, snapshots: overview.snapshotCount })} icon="trend" />
