...
import LoginLanguagePrompt from "@/app/components/LoginLanguagePrompt";
import PasswordInput from "@/app/components/PasswordInput";
import { loginAction } from "@/app/login/actions";
import LocaleSwitcher from "@/app/components/LocaleSwitcher";
import { getTranslations } from "next-intl/server";
import { hasSelectedLoginLanguage } from "@/i18n/locale-cookie";
...
export default async function LoginPage({ searchParams }: LoginPageProps) {
  const [t, tErrors, hasLanguageChoice] = await Promise.all([
  ...
  return (
    <LoginLanguagePrompt initiallyOpen={!hasLanguageChoice}>
      <DesktopOnly>
